...
check("positive prompt", text.startswith("1girl, solo <lora:"), text.splitlines()[0])
...
check("negative prompt", "Negative prompt: bad hands" in text)
...
check("empty negative dropped", "Negative prompt" not in stock)
